...
.footer-section ul li a:hover {
    color: #3498db; /* Highlight color for hover */
...
.footer-bottom {
    text-align: center;
    padding: 0px 0;
    border-top: 1px solid #34495e; /* Subtle border to separate footer sections */
}
...
<div class="footer">
    <div class="footer-container">
        ...
        <div class="footer-section">
            <h2>Address</h2>
            <p><i class="fas fa-map-marker-alt"></i> KL UNIVERSITY, VADESWARAM, MANGALAGIRI DISTRICT, VIJAYAWADA, INDIA</p>
            <p><i class="fas fa-phone"></i> +91 92345 67089</p>
